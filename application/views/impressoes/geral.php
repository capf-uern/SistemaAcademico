...
<div class="bg_geral">
		        ...
		        if(count($usuario) == 0){
					...
					foreach ($usuario as $list) {
						echo '<p class="texto_minicurso">
						Certificamos que <span class="texto_nome">'. strtoupper ($list->nome) .'</span> participou da XVII Semana Universitária, promovida pelo Campus Avançado “Profa. Maria Elisa de Albuquerque Maia” (CAMEAM), da Universidade do Estado do Rio Grande do Norte (UERN), no período de 04 a 07 de outubro de 2017, perfazendo a carga-horária de 30 horas. 
						</p>';
