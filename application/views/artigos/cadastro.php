        ...
        <div class="col s12 m12">
          <div class="card white">
            <div class="card-action grey lighten-2">
              <a href="#" class="card-content black-text"><strong>Novo Resumo Expandido</strong></a>
            </div>
            		...
            		<form action="<?php echo base_url() . $this->uri->segment(1); ?>/cadastrar/" method="post" class="col s12 m12 l12" enctype="multipart/form-data">
				      ...
				      <div class="row">
						<div class="input-field col s12 m12 l12">
				          ...
				          <label for="titulo">Título do Resumo Expandido</label>
				        </div>
				       </div>
				       ...
				       <div class="row">
				        <div class="input-field col s12 m11 l11">
				          ...
				          <input name="coautor1_cod" value="<?php echo set_value('coautor1_cod'); ?>" id="coautor1_cod" type="text" class="validate white-text white retira_border" readonly>
				        ...
				        <div class="input-field col s12 m11 l11">
				      	...
				      	<div class="input-field col s12 m1 l1">
				          <input name="coautor2_cod" value="<?php echo set_value('coautor2_cod'); ?>" id="coautor2_cod" type="text" class="validate white-text white retira_border" readonly>
				        ...
				        <div class="input-field col s12 m11 l11">
				      	...
				      	<div class="input-field col s12 m1 l1">
				          <input name="coautor3_cod" value="<?php echo set_value('coautor3_cod'); ?>" id="coautor3_cod" type="text" class="validate white-text white retira_border" readonly>
