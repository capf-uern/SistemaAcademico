            ...
            <?php } ?>
        			...
        			<table class="bordered responsive-table">
				        ...
				        <?php if(count($listagem) <= 0){
				        	echo '<tr>
				        	<td colspan="3"><h6>Nenhum pôster publicado para esse Grupo de Trabalho</h6></td>
				        	</tr>';
				        } ?>
				        ...
				        <?php foreach ($listagem as $list) { ?>
				          	<tr>
					            ...
					            <td class="center-align">
					            	...
					            	<a href="<?php echo base_url('artigos/editarposter') . "/" . $list->posterID; ?>"" class="btn btn-small tooltipped waves-effect waves-blue blue darken-4" data-position="top" data-delay="50" data-tooltip="Editar Pôster"><i class="small material-icons">edit</i></a>
