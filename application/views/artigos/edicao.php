	...
	<div class="row">
        <div class="col s12 m12">
          <div class="card white">
            ...
            <div class="row">
            		<form action="<?php echo base_url() . $this->uri->segment(1); ?>/editado/<?php echo $list->artigoID; ?>" method="post" class="col s12 m12 l12">
			        	...
			        	<div class="input-field col s12">
						    <select name="grupotrabalho" required>
						      ...
						      <?php foreach ($gt as $listgt) { ?>
						      	<option value="<?php echo $listgt-> id; ?>" <?php echo ($list->Grupo_Trabalho_id == $listgt->id) ? 'selected="selected"' : ''; ?>><?php echo $listgt->titulo . ' - Coord.: ' . $listgt->nome . '</option>';
						      } ?>
						    </select>
				      ...
				      <div class="row">
						<div class="input-field col s12 m12 l12">
				          <input name="titulo" value="<?php echo $list->artigoTitulo; ?>" id="titulo" type="text" class="validate">
