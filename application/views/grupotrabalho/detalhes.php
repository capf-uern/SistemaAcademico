...
<div class="container" style="margin-top: 2%;">
				          	...
				          	<tr>
								<td class="">
									<?php if($list->certificado == '0'){ ?>
										<a href="<?php echo base_url('grupotrabalho/certificado') . "/" . $list->Artigo_id; ?>" class="btn btn-small tooltipped waves-effect waves-red red darken-4" data-position="top" data-delay="50" data-tooltip="Gerar certificado"><i class="small material-icons">access_alarms</i></a>
									<?php }else{ ?>
					            ...
					            <td class="center-align">
									...
									<?php if($list->situacao == 1){ ?>
										<a href="<?php echo base_url('uploads/files') . '/'. $list->arquivo; ?>" class="btn btn-small tooltipped waves-effect waves-green green" data-position="top" data-delay="50" data-tooltip="Resumo Expandido Aprovado" target="_blank"><i class="fa fa-file-pdf-o" aria-hidden="true"></i></a>
									<?php }elseif($list->situacao == 2){ ?>
										<a href="<?php echo base_url('uploads/files') . '/'. $list->arquivo; ?>" class="btn btn-small tooltipped waves-effect waves-teal  teal " data-position="top" data-delay="50" data-tooltip="Resumo Expandido Aprovado com ressalva" target="_blank"><i class="fa fa-file-pdf-o" aria-hidden="true"></i></a>
									<?php }elseif($list->situacao == 3){ ?>
										<a href="<?php echo base_url('uploads/files') . '/'. $list->arquivo; ?>" class="btn btn-small tooltipped waves-effect waves-red  red " data-position="top" data-delay="50" data-tooltip="Resumo Expandido reprovado" target="_blank"><i class="fa fa-file-pdf-o" aria-hidden="true"></i></a>
					            	...
					            	<a href="<?php echo base_url('grupotrabalho/editar') . "/" . $list->artigoID; ?>"" class="btn btn-small tooltipped waves-effect waves-blue blue darken-4" data-position="top" data-delay="50" data-tooltip="Editar Resumo Expandido"><i class="small material-icons">edit</i></a>
  ...
  <form action="<?php echo base_url() . $this->uri->segment(1); ?>/removeartigo/<?php echo $list->artigoID; ?>" method="post">
	    <div class="modal-content">
	      ...
	      <p>Remover o Artigo <?php echo $list->titulo; ?>
	      </p>	
	    </div>
