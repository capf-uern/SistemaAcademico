...
<div class="container" style="margin-top: 2%;">
	...
	<div class="row">
		...
		<div class="col s12 m6 l6">
			<?php foreach ($curso as $curse) { ?>
				<a href='<?php echo base_url('impressoes/oficinas'). '/' . $curse->id_oficina; ?>' class="waves-effect waves-light blue accent-4
 btn right"><i class="material-icons right">list</i> Lista de Presença </a>
			<?php } ?>
		</div>
  	</div>
          ...
          <div class="card white">
            <div class="card-content black-text"> <!-- DIV CARD-CONTENT -->
            	...
            	<?php foreach ($curso as $lista) { 
            		$nome_oficina = $lista->titulo;
            	}?>

        			<table class="striped bordered responsive-table">
        				<div class="card-panel grey lighten-2"><h5 style="margin: 0;"><strong><?php echo $nome_oficina; ?></strong></h5></div>
					    ...
					    foreach ($listagem as $list) { ?>
					          ...
					          <tr>
					            ...
					            <?php if($list->presente !='1'){ ?>
					            	<a href="<?php echo base_url('oficinas/presente') . "/" . $list->id_usuario; ?>/<?php echo $list->Oficina_id; ?>" class="btn btn-small tooltipped waves-effect waves-teal deep-orange" data-position="top" data-delay="50" data-tooltip="Confirmar Participação"><i class="small material-icons">access_alarms</i></a>
					            <?php }else{  ?>
...
<?php foreach ($listagem as $list) { ?>
  ...
  <form action="<?php echo base_url() . $this->uri->segment(1); ?>/removeInscricao/<?php echo $list->id_usuario; ?>/<?php echo $list->Oficina_id; ?>" method="post">
