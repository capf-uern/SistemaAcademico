...
<div class="container" style="margin-top: 2%;">
            ...
            <?php } ?>
        			...
        			<table class="bordered responsive-table">
				        ...
				        <?php if(count($listagem) <= 0){
				        	echo '<tr>
				        	<td colspan="3"><h6>Nenhum pôster publicado para essa coordenação</h6></td>
				        	</tr>';
				        } ?>
				        ...
				        <?php foreach ($listagem as $list) { ?>
				          	<tr>
					            ...
					            <td class="center-align">
					            	...
					            	<a href="<?php echo base_url('posteres/postereditar') . "/" . $list->posterID; ?>"" class="btn btn-small tooltipped waves-effect waves-blue blue darken-4" data-position="top" data-delay="50" data-tooltip="Editar Pôster"><i class="small material-icons">edit</i></a>
  ...
  <form action="<?php echo base_url() . $this->uri->segment(1); ?>/removeposter/<?php echo $list->posterID; ?>" method="post">
  ...
  <form action="<?php echo base_url() . $this->uri->segment(1); ?>/cartaaceite/<?php echo $list->posterID; ?>" method="post" enctype="multipart/form-data">
	    <div class="modal-content">
