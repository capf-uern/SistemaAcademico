	...
	<div class="container" style="margin-top: 2%;">
		...
		<div class="row">
			...
			<div class="col s12 m6 l6">
				<?php /*
					<a href='<?php echo base_url() . $this->uri->segment(1); ?>/cadastro' class="waves-effect waves-light cyan darken-4 btn right">Enviar Pôster <i class="material-icons right">queue</i></a>
 */ ?>
	        </div>
	        ...
	        <div class="col s12 m12">
	          <div class="card white">
	            <div class="card-content black-text"> <!-- DIV CARD-CONTENT -->
	            	...
	            	<div class="card-panel grey lighten-2"><strong>Pôsteres publicados</strong></div>
					        ...
					        <?php foreach ($listagem as $list) { ?>
					          ...
					          <tr>
					            ...
					            <td class="left-align">
					            	...
					            	foreach ($this->listagem->listarCoAutores($list->posterID) as $autores)
					            	{
					            ...
					            <td class="right-align">
					            	...
					            	<?php 
					            	if(($list->situacao == '1') OR ($list->situacao == '2') OR ($list->situacao == '3')){ ?>
					            		...
					            		<button data-target="modal-parecer<?php echo $list->posterID; ?>" class="btn btn-small tooltipped waves-effect waves-green green darken-3 modal-trigger col s112 m12 l12" data-position="top" data-delay="50" data-tooltip="Ler Parecer">parecer</button>
					    ...
					    <div class="card-panel grey lighten-2"><strong>Participação em Pôsteres</strong></div>
	        			...
	        			<table class="striped responsive-table">
					        ...
					        <?php foreach ($participa as $part) { ?>
					          ...
					          <tr>
					            ...
					            <td class="left-align">
					            <?php 
					            	foreach ($this->listagem->listarAutores($part->posterID) as $autores)
					            	{

					            		echo '<strong>' . $autores->nome . '</strong><br>';
					            		
					            	}
					            	foreach ($this->listagem->listarCoAutores($part->posterID) as $coautores)
					            	{
					            ...
					            <td class="center-align">
					            	...
					            	<a href="<?php echo base_url('uploads/files') . '/'. $part->arquivo; ?>" class="btn btn-small tooltipped waves-effect waves-orange orange" data-position="top" data-delay="50" data-tooltip="Visualizar Pôster" target="_blank"><i class="fa fa-file-pdf-o" aria-hidden="true"></i></a>
