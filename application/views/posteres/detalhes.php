				        ...
				        <?php foreach ($listagem as $list) { ?>
				          	<tr>
					            ...
					            <td class="center-align">
					            	...
					            	<a href="<?php echo base_url('posteres/editar') . "/" . $list->posterID; ?>"" class="btn btn-small tooltipped waves-effect waves-blue blue darken-4" data-position="top" data-delay="50" data-tooltip="Editar Pôster"><i class="small material-icons">edit</i></a>
