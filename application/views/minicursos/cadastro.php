        ...
        <div class="col s12 m12">
          <div class="card white">
            <div class="card-action grey lighten-2">
              <a href="#" class="card-content black-text"><strong>Novo Minicurso</strong></a>
            </div>
            ...
            <div class="row">
            		<form action="<?php echo base_url() . $this->uri->segment(1); ?>/cadastrar/" method="post" class="col s12 m12 l12">
					  ...
					  <div class="row  center-align">
							<a href='<?php echo base_url('minicursos/listagem'); ?>' class="waves-effect waves-light btn grey darken-1">Cancelar</a>
